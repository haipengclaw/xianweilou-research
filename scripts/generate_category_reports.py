...
# Load search data
with open('/Users/macclaw/hudadao-r-and-d-assistant/data/search_results.json') as f:
    searches = json.load(f)

DATA_DIR = '/tmp/shops'
OUTPUT_DIR = '/Users/macclaw/hudadao-r-and-d-assistant/reports'
...
function toggleDish(btn, dishName, shopName) {{
